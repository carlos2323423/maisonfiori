                                ...
                                @switch($space)
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input name="{{ $space }}" type="date" class="form-control form-control-user"
                                                id="MODAL_id_{{ $space }}" placeholder="Fecha de ingreso" value="{{ old( $space ) }}">
                                        </div>
                                    </div>
                                    @break
                                    @case('foto')
                                    <div class="form-group">
                                        <div>
                                            <div class="d-flex justify-content-center mb-4">
                                                <img src="{{ old('imageuser') ? old('imageuser') : $imageuser }}" class="rounded-circle"
                                                    alt="ejemplo de avatar" style="width: 200px;" id="MODAL_id_avatar" />
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <div class="btn btn-primary btn-rounded" id="foto_imputcontainer">
                                                    <label class="form-label text-white m-1" for="MODAL_id_{{ $space }}"
                                                        onclick="inputfile_restaur('MODAL_id_{{ $space }}')">Seleccionar archivo</label>
                                                    <input name="{{ $space }}" type="file" class="form-control d-none"
                                                        id="MODAL_id_{{ $space }}" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input name="{{ $space }}" type="password" class="form-control form-control-user"
                                                id="MODAL_id_{{ $space }}" placeholder="Contraseña" value="{{ old( $space ) }}">
                                        </div>
                                        <div class="col-sm-6">
                                            <input name="password_confirmation" type="password" class="form-control form-control-user"
                                                id="Repeat_MODAL_id_{{ $space }}" placeholder="Repetir contraseña"
                                    ...
                                    @default
                                    <div class="form-group">
                                        <input name="{{ $space }}" type="" class="form-control form-control-user"
                                            id="MODAL_id_{{ $space }}" placeholder="{{ $space }}" value="{{ old( $space ) }}">
                                    </div>
                                    @break
                                @endswitch
                            @endif
